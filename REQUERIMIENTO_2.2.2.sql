...
--CONSULTA Y VISTA COMO DESARROLLADOR 1
SELECT
    SUBSTR(P.NUMRUN,1,2)||(SEQ_RUN.NEXTVAL)||SUBSTR(P.NUMRUN,3,6)||SUBSTR(P.PNOMBRE,1,2)||'-'||P.DVRUN||(SEQ_DVRUN.NEXTVAL) AS "RUN POSTULANTE",
